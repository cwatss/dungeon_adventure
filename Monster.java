...
public abstract class Monster extends DungeonCharacter {
    ...
    private static String healSoundPath = "heal.wav";
...
//    private String getHealSoundPath(){
//        // Here we'll use the static field since all healing sounds are the same across instances.
//        return healSoundPath;
//    }
    ...
    public void heal() {
        ...
        System.out.println(getName()+" healed by "+healPoints+" points!");

        // PLAY SOUND
        soundPlayer.play(healSoundPath);
    }
